...
- <code title="get /research">client.research.<a href="./src/caesar/resources/research/research.py">list</a>(\*\*<a href="src/caesar/types/research_list_params.py">params</a>) -> <a href="./src/caesar/types/research_list_response.py">ResearchListResponse</a></code>
...
- <code title="get /research/files">client.research.files.<a href="./src/caesar/resources/research/files.py">list</a>(\*\*<a href="src/caesar/types/research/file_list_params.py">params</a>) -> <a href="./src/caesar/types/research/file_list_response.py">FileListResponse</a></code>
