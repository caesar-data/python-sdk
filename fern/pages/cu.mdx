...
<ParamField query="compute_units" type="integer" default="3">
...
<CardGroup cols={2}>
  <Card title="Start conservative" icon="gauge">
    Begin with CU 3 (default) and adjust based on response quality. Most queries achieve optimal results at this level.
  </Card>
...
5. **Consider time-to-insight tradeoffs**sometimes multiple focused CU 3 queries beat a single CU 10 query