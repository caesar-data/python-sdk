...
<AccordionGroup>
  <Accordion title="Compute Units">
    Control research depth with compute units (1-10). Each unit represents ~1 minute of processing and enables additional reasoning loops. Most queries work well with the default of 3 CU.
